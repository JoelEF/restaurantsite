    ...
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        brand: { 50:'#fff8ed',100:'#ffefd3',200:'#ffdba6',300:'#ffc16d',400:'#ff9d32',500:'#ff7f0a',600:'#e56200',700:'#bf4802',800:'#973a0b',900:'#7a310c' },
                        dark: '#1a1a1a',
                    },
...
<body class="bg-gray-50 font-sans text-gray-800 antialiased">
    ...
    <!-- Navigation -->
    <nav class="bg-gray-900 text-white sticky top-0 z-50 shadow-2xl" x-data="{ mobileOpen: false }">
    ...
    <div class="bg-green-50 border-l-4 border-green-500 p-4 m-4 rounded-r-lg" x-data="{ show: true }" x-show="show">
        <div class="flex items-center justify-between">
            ...
            <button @click="show = false" class="text-green-400 hover:text-green-600 ml-4">✕</button>
        </div>
    </div>
    @endif
    ...
    <!-- Footer -->
    <footer class="bg-gray-900 text-gray-400 pt-16 pb-8 mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="{{ route('menu.index') }}" class="hover:text-orange-400 transition-colors">Ons Menu</a></li>
                        <li><a href="{{ route('order.index') }}" class="hover:text-orange-400 transition-colors">Online Bestellen</a></li>
                        <li><a href="{{ route('reservation.index') }}" class="hover:text-orange-400 transition-colors">Tafel Reserveren</a></li>
                        <li><a href="{{ route('order.track') }}" class="hover:text-orange-400 transition-colors">Bestelling Volgen</a></li>
                    </ul>
                </div>
                <div>
